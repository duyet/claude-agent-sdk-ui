...
import { PlanApprovalModal } from "@/components/chat/plan-approval-modal"
import { QuestionModal } from "@/components/chat/question-modal"
...
function ChatContainerInner() {
  const { sendMessage, sendAnswer, sendPlanApproval, isStreaming } = useChat()
