...
import { REFRESH_COOKIE, SESSION_COOKIE, setSessionCookie, verifySession } from "@/lib/session"
...
async function proxyRequest(
  ...
  const headersToForward = ["content-type", "accept", "accept-language", "cache-control", "pragma"]
  ...
  try {
    ...
    const responseHeadersToForward = ["content-type", "cache-control", "etag", "last-modified"]
